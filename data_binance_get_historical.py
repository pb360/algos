...
def download_binance_trades(exchange, pair, start_date, end_date, output="quiet", pickle_failed_days=False):
    i = 0
    failed_dates = []
    for date in generate_dates(start_date, end_date, date_out_type="tuple"):
        ...
        get_spot_trades_convert_to_algos_delete_temp_csv_n_zip(pair=pair, date_tuple=date, exchange=exchange)
